          ...
          <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
            <div className="md:w-1/3 w-full">
              <img
                ...
                alt="Vishal Sahu"
                className="rounded-xl shadow-lg object-cover w-full h-72 md:h-full"
              />
            </div>
            <div className="md:w-2/3 w-full prose prose-lg dark:prose-invert text-gray-700 dark:text-gray-300">
              <p>
                Welcome to <strong>VishalTechZone</strong>, your ultimate destination for the latest insights, news, and updates in the world of cryptocurrency and blockchain technology.
              </p>
              <p>
                Our mission is to provide accurate, timely, and insightful information to help our readers navigate the complexities of the crypto space. Whether you're a seasoned investor or a curious newcomer, we have something for you.
              </p>
              <p>
                Founded by a team of passionate enthusiasts, VishalTechZone stands out for its commitment to integrity, transparency, and excellence.
              </p>
            </div>
          </div>
